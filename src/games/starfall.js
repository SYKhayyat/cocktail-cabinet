...
export class StarfallGame {
  ...
  draw(context) {
    ...
    this.stars.forEach((star) => { context.strokeStyle = "#fb7185"; context.lineWidth = 3; context.beginPath(); context.moveTo(star.x - 7, star.y - 7); context.lineTo(star.x + 7, star.y + 7); context.moveTo(star.x + 7, star.y - 7); context.lineTo(star.x - 7, star.y + 7); context.stroke(); });
    ...
    drawText(context, this.side === "runner" ? "Move the mouse left and right · collect blue gems · avoid red stars" : "Click the sky to send a star · the computer dodges", 16, 28, 14, "#cbd5e1");
