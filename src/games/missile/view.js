...
function drawMissile(context, missile) {
  const dx = missile.freeFlight ? missile.vx : missile.targetX - missile.x; const dy = missile.freeFlight ? missile.vy : missile.targetY - missile.y; const length = Math.max(Math.hypot(dx, dy), 1);
