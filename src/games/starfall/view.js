...
export function draw(model, context) {
  ...
  drawText(context, model.side === "runner" ? "Move the mouse left and right · collect blue gems · avoid red stars" : "Click the sky to send a star · the computer dodges", 16, 28, 14, "#cbd5e1");
