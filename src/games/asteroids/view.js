...
export function draw(model, context) {
  ...
  else drawText(context, model.side === "ship" ? "Move the mouse to swivel · click or hold to fire · WASD also works" : "Click the sky to send a rock · the computer shoots it", 16, 28, 14, "#cbd5e1");
